...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GrowingTextView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15GrowingTextView15GrowingTextView")
...
SWIFT_PROTOCOL("_TtP15GrowingTextView23GrowingTextViewDelegate_")
